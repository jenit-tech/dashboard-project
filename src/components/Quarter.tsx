...
const Quarter = () => {
    ...
    return (
        <div className="w-full h-[261px] rounded-[16px] bg-white  p-4 flex flex-col items-center justify-between m-2 ">
        {/* Top title */}
        ...
        <div className="relative w-[200px] h-[100px] flex items-center justify-center" >
          ...
          >
            ...
            <RadialBar
              background
              cornerRadius={10} // 👈 Rounds the corners (adjust pixel value as needed)
